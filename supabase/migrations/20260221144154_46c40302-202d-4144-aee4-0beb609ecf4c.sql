...
-- ============================================
CREATE TABLE IF NOT EXISTS public.project_state_graphs (
...
CREATE INDEX IF NOT EXISTS idx_state_graphs_project ON public.project_state_graphs(project_id);
...
CREATE INDEX IF NOT EXISTS idx_scenarios_project ON public.project_scenarios(project_id, scenario_type);
CREATE INDEX IF NOT EXISTS idx_scenarios_active ON public.project_scenarios(project_id, is_active) WHERE is_active = true;
...
CREATE INDEX IF NOT EXISTS idx_snapshots_scenario ON public.scenario_snapshots(scenario_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_snapshots_project ON public.scenario_snapshots(project_id);
...
CREATE INDEX IF NOT EXISTS idx_drift_alerts_project ON public.drift_alerts(project_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_drift_alerts_unacked ON public.drift_alerts(project_id, acknowledged) WHERE acknowledged = false;

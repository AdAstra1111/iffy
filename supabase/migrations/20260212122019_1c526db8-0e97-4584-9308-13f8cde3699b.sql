...
CREATE TABLE IF NOT EXISTS public.development_briefs (
...
ALTER TABLE public.pitch_ideas ADD COLUMN IF NOT EXISTS brief_id UUID REFERENCES public.development_briefs(id) ON DELETE SET NULL;

-- Add scoring columns to pitch_ideas
ALTER TABLE public.pitch_ideas ADD COLUMN IF NOT EXISTS score_market_heat NUMERIC DEFAULT 0;
ALTER TABLE public.pitch_ideas ADD COLUMN IF NOT EXISTS score_feasibility NUMERIC DEFAULT 0;
ALTER TABLE public.pitch_ideas ADD COLUMN IF NOT EXISTS score_lane_fit NUMERIC DEFAULT 0;
ALTER TABLE public.pitch_ideas ADD COLUMN IF NOT EXISTS score_saturation_risk NUMERIC DEFAULT 0;
ALTER TABLE public.pitch_ideas ADD COLUMN IF NOT EXISTS score_company_fit NUMERIC DEFAULT 0;
ALTER TABLE public.pitch_ideas ADD COLUMN IF NOT EXISTS score_total NUMERIC DEFAULT 0;

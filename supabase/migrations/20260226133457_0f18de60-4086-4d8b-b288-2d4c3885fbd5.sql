...
CREATE TABLE IF NOT EXISTS public.style_evals (
...
CREATE INDEX IF NOT EXISTS idx_style_evals_project ON public.style_evals(project_id);
CREATE INDEX IF NOT EXISTS idx_style_evals_version ON public.style_evals(version_id);
CREATE INDEX IF NOT EXISTS idx_style_evals_document ON public.style_evals(document_id);

...
CREATE TABLE IF NOT EXISTS public.project_issue_lifecycle_events (
...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_pile_project_source ON public.project_issue_lifecycle_events (project_id, source_table);
CREATE INDEX IF NOT EXISTS idx_pile_source_row ON public.project_issue_lifecycle_events (source_table, source_row_id);
CREATE INDEX IF NOT EXISTS idx_pile_project_created ON public.project_issue_lifecycle_events (project_id, created_at DESC);

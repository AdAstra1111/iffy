...
DECLARE
  ...
  v_sections jsonb := '[
    ...
    {"key":"hero_frames","label":"Hero Frames","order":7},
    {"key":"poster_directions","label":"Poster Directions","order":8}
  ]'::jsonb;
  v_sec jsonb;
BEGIN
  ...
  UPDATE public.lookbook_sections SET display_order = 7
  WHERE project_id = p_project_id AND section_key = 'hero_frames';
  UPDATE public.lookbook_sections SET display_order = 8

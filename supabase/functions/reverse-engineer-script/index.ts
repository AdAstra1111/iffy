...
async function storeDoc(
  ...
  // ── CANONICAL: use doc-os.createVersion() instead of direct insert ──
  ...
  const ver = await createVersion(sb, {
    ...
    inputsUsed: { extracted_from: script_document_id, source: "reverse-engineer-script" },
    metaJson: { ci: 85, gp: 88, reverse_engineered: true, extracted_from: script_document_id },
  });

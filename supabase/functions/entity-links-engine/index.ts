...
const NOISE_WORDS = new Set([
  ...
  // Location/time nouns (scene heading artifacts)
  "BATHROOM","KITCHEN","LIVING","DINING","BEDROOM","CLASSROOM",
  "HALLWAY","CORRIDOR","STAIRCASE","ELEVATOR","LOBBY","GARAGE","BASEMENT",
  "TABLE","DESK","COUNTER","DOORWAY","ENTRANCE","EXIT",
  "STEREO","RADIO","TELEVISION","SCREEN","MONITOR","COMPUTER","PHONE",
  "MANOR","MANSION","APARTMENT","CABIN","COTTAGE","BARN","SHED",
  "CAR","TRUCK","VAN","BUS","TAXI","VEHICLE","WINDSHIELD","REARVIEW",
  "DRIVEWAY","SIDEWALK","PARKING","ROOFTOP","BALCONY","PATIO",
  "RIVER","LAKE","OCEAN","BEACH","FOREST","WOODS","MOUNTAIN","VALLEY","FIELD",
  "MORNING","AFTERNOON","EVENING","NIGHTTIME","MIDNIGHT","NOON","DAWN","DUSK",
  "SUNRISE","SUNSET","OVERNIGHT","MOMENTS","MINUTES","HOURS",
  "PROLOGUE","EPILOGUE","PAGE","ACT","CARD",
  "EVERYONE","EVERYBODY","SOMEONE","ANYONE","NOBODY","SOMEBODY",
  "INTERIOR","EXTERIOR","ESTABLISHING","WIDESHOT","MEDIUM",
  "NEARBY","INSIDE","OUTSIDE","BESIDE","BEHIND","ABOVE","BELOW","ACROSS",
  "NARRATOR","HOST","ANNOUNCER","REPORTER",
]);
...
const ROLE_NOISE = new Set([
  ...
  "CROWD","VOICE","VOICES",
  "DETECTIVE","SERGEANT","CAPTAIN","GENERAL","COLONEL",

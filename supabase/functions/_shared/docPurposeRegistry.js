 ...
 */
export function getDocPurposeClass(docType) {
...
export const PURPOSE_SCORING_RUBRICS = {
...
export const PURPOSE_REWRITE_GOALS = {
    DEVELOPMENT_ARCHITECTURE: `- Deepen the creative architecture: character specificity, structural clarity, thematic integration, arc completeness.
...
- OUTPUT THE COMPLETE DOCUMENT — all sections, all characters/beats/acts — do not truncate.`,
    PREMISE_POSITIONING: `- Strengthen premise clarity, hook specificity, and commercial legibility.
...
- Do not flatten voice for minor commercial gain.`,
    PACKAGING_COMMERCIAL: `- Sharpen commercial argument, positioning clarity, and market specificity.
...
- Do NOT introduce narrative depth or character backstory unless explicitly requested.`,
    SCRIPT_EXECUTION: `- Strengthen dialogue craft, scene dynamics, and dramatic impact.

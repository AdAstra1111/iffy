export function normalizeWritingLane(lane) {
 ...
 */ export function getWritingLaneGroup(lane, format) {
...
export const DEFAULT_WRITING_VOICE_BY_GROUP = {
  vertical: {
...
export function getDefaultWritingVoiceForLane(lane, format) {

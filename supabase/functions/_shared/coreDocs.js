 ...
 */
export async function fetchCoreDocs(supabase, projectId, overrides) {
    const result = {
        characterBible: '',
 ...
 */
export function extractCharacterCues(scriptText) {
    const cues = new Set();
 ...
 */
export function extractBibleCharacters(characterBible) {
    const names = new Set();
    if (!characterBible)
        return names;

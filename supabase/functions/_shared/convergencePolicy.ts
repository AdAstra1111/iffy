 ...
 */ export function getAttemptStrategy(attemptNumber) {
  switch(attemptNumber){
    case 1:
      return "TARGETED_BLOCKERS";
    case 2:
      return "HIGH_IMPACT_ONLY";
    case 3:
      return "STRUCTURE_REPAIR";
    case 6:
    case 8:
    case 10:
      return "FULL_REWRITE_CONSTRAINED";
    default:
      return "FORK_CONSERVATIVE_AGGRESSIVE"; // 4, 5, 7, 9, 11+
  }
}
/**
 * Select notes based on strategy.
 */ export function selectNotesForStrategy(strategy, allNotes) {
 ...
 */ export function getForkDirections() {
  return {
    conservative: [

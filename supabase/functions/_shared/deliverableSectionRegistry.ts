...
const CONCEPT_BRIEF_SECTIONS: SectionDefinition[] = [
  ...
  { section_key: "protagonist",         label: "Protagonist",              match_mode: "heading_regex", match_pattern: "^#+\\s*protagonist",                                    allows_partial_rewrite: true, repair_mode: "replace_section", order: 3 },
  ...
  { section_key: "stakes",              label: "Stakes",                   match_mode: "heading_regex", match_pattern: "^#+\\s*stakes",                                         allows_partial_rewrite: true, repair_mode: "replace_section", order: 8 },
  { section_key: "tone_and_style",      label: "Tone & Atmosphere",        match_mode: "heading_regex", match_pattern: "^#+\\s*tone(?:\\s*(?:&|and)\\s*atmosphere)?",           allows_partial_rewrite: true, repair_mode: "replace_section", order: 9 },
  { section_key: "themes",              label: "Themes",                   match_mode: "heading_regex", match_pattern: "^#+\\s*themes?",                                        allows_partial_rewrite: true, repair_mode: "replace_section", order: 10 },

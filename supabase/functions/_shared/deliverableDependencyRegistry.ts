...
const REGISTRY = {
  feature_film: [
    ...
    {
      from_doc_type: "scene_graph",
      to_doc_type: "narrative_units",
      kind: "canon",
      strength: "hard",
      invalidation_policy: "stale",
      revalidation_policy: "must_reanalyze"
    },
    // scene_graph → narrative_scene_entity_links: scene changes invalidate which entity appears in which scene
    {
      from_doc_type: "scene_graph",
      to_doc_type: "narrative_scene_entity_links",
      kind: "canon",
      strength: "hard",
      invalidation_policy: "stale",
      revalidation_policy: "must_reanalyze"
    ...
    {
      from_doc_type: "narrative_units",
      to_doc_type: "character_bible",
      kind: "canon",
      strength: "soft",
      invalidation_policy: "review_only",
      revalidation_policy: "optional_review"
    },
    // narrative_scene_entity_links → character_bible: link changes affect character arc moments
    {
      from_doc_type: "narrative_scene_entity_links",
      to_doc_type: "character_bible",
      kind: "canon",
      strength: "soft",
      invalidation_policy: "review_only",
    ...
    {
      from_doc_type: "narrative_entities",
      to_doc_type: "production_draft",
      kind: "production",
      strength: "soft",
      invalidation_policy: "advisory",
      revalidation_policy: "optional_review"
    },
    // idea → concept_brief
    {
      from_doc_type: "idea",
      to_doc_type: "concept_brief",
      kind: "canon",
      strength: "hard",
      invalidation_policy: "stale",
      revalidation_policy: "must_reanalyze"
    ...
    {
      from_doc_type: "concept_brief",
      to_doc_type: "market_sheet",
      kind: "market",
      strength: "hard",
      invalidation_policy: "stale",
      revalidation_policy: "must_reanalyze"
    ...
    {
      from_doc_type: "treatment",
      to_doc_type: "story_outline",
      kind: "structure",
      strength: "hard",
      invalidation_policy: "stale",
      revalidation_policy: "must_reanalyze"
    ...
    {
      from_doc_type: "production_draft",
      to_doc_type: "deck",
      kind: "advisory",
      strength: "soft",
    ...
    {
      from_doc_type: "narrative_entity_relations",
      to_doc_type: "scene_enrichment",
      kind: "canon",
      strength: "soft",
      invalidation_policy: "stale",
  ...
  series: [
    ...
    {
      from_doc_type: "episode_script",
      to_doc_type: "season_master_script",
      kind: "structure",
      strength: "hard",
      invalidation_policy: "stale",
      revalidation_policy: "must_reanalyze"
    ...
    {
      from_doc_type: "season_master_script",
      to_doc_type: "production_draft",
      kind: "structure",
      strength: "hard",
      invalidation_policy: "stale",
  ...
  vertical_drama: [
    ...
    {
      from_doc_type: "concept_brief",
      to_doc_type: "vertical_market_sheet",
      kind: "market",
      strength: "hard",
      invalidation_policy: "stale",
      revalidation_policy: "must_reanalyze"
    ...
    {
      from_doc_type: "season_arc",
      to_doc_type: "episode_grid",
      kind: "structure",
      strength: "hard",
      invalidation_policy: "stale",
      revalidation_policy: "must_reanalyze"
    ...
    {
      from_doc_type: "episode_grid",
      to_doc_type: "vertical_episode_beats",
      kind: "structure",
      strength: "hard",
      invalidation_policy: "stale",
      revalidation_policy: "must_reanalyze"
    ...
    {
      from_doc_type: "vertical_episode_beats",
      to_doc_type: "season_script",
      kind: "structure",
      strength: "hard",
      invalidation_policy: "stale",
  ...
  documentary: [
    ...
    {
      from_doc_type: "concept_brief",
      to_doc_type: "documentary_outline",
      kind: "canon",
      strength: "hard",
      invalidation_policy: "stale",
      revalidation_policy: "must_reanalyze"
    ...
    {
      from_doc_type: "documentary_outline",
      to_doc_type: "deck",
      kind: "structure",
      strength: "hard",
      invalidation_policy: "stale",
...
// ── Public API ───────────────────────────────────────────────────────────
/** Get all direct dependents of a doc type in a given lane */ export function getDirectDependents(lane, docType) {
  return _getEdgeIndex(lane)[docType] || [];
}
/** Get a specific edge between two doc types */ export function getDependencyEdge(lane, fromDocType, toDocType) {
  const edges = getDirectDependents(lane, fromDocType);
  return edges.find((e)=>e.to_doc_type === toDocType) || null;
}
/** Get transitive dependents (BFS) — returns unique doc types reachable downstream */ export function getTransitiveDependents(lane, docType) {
...
const INVALIDATION_RANK = {
  none: 0,
  review_only: 1,
  stale: 2
};
const REVALIDATION_RANK = {
  none: 0,
  optional_review: 1,
  must_reanalyze: 2
};
 ...
 */ export function getInvalidationPlan(lane, repairedDocType) {
  ...
  return {
    ...
    lane,
    entries,
    skipped_doc_types: skipped
  };
}
/** Check if a lane has explicit registry entries */ export function hasRegistryEntries(lane) {

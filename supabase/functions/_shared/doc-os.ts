...
export interface CreateVersionOpts {
  ...
  status?: string;
  /** Convergence fields — used by generate-document for staleness tracking */
  isStale?: boolean;
  staleReason?: string | null;
  /** Generator run ID for tracing specific generation runs */
  generatorRunId?: string | null;
  /** Style template version linkage */
  styleTemplateVersionId?: string | null;
}

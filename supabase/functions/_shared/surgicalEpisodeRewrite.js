 ...
 */
export function parseEpisodeBlocks(plaintext) {
 ...
 */
export function patchEpisodeBlocks(original, patches) {
 ...
 */
export function extractMentionedEpisodes(note) {
 ...
 */
export async function llmIdentifyAffectedEpisodes(apiKey, note, episodeHeaders, totalEpisodes, callLLM) {
    const MAX = 10;
 ...
 */
export async function rewriteSingleEpisode(episodeBlock, note, prevBlock, nextBlock, docType, upstreamContext, callLLM) {
 ...
 */
export async function surgicalEpisodeRewrite(params) {
    ...
    for (const epNum of validNums) {
        ...
        const rewritten = await rewriteSingleEpisode(block, note, prevBlock, nextBlock, docType, upstreamContext, callLLM);

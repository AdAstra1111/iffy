...
const registry: Record<DeliverableType, ReviewSchema> = {
  ...
  visual_project_bible: {
    rubricSections: [
      { dimension: 'Visual Tone', weight: 15, description: 'Is the overall visual identity articulated with specific references and palette/mood language?' },
      { dimension: 'World Visual Language', weight: 15, description: 'Are the visual rules of the story world defined with recurring aesthetic logic?' },
      { dimension: 'Character Visual Profiles', weight: 15, description: 'Are principal characters visually specified with clear differentiation?' },
      { dimension: 'Wardrobe System', weight: 10, description: 'Is wardrobe logic defined per character and arc phase?' },
      { dimension: 'Location Language', weight: 10, description: 'Are locations visually specified with mood, palette, texture, and production design?' },
      { dimension: 'Motif System', weight: 10, description: 'Are recurring visual motifs identified and meaningfully integrated?' },
      { dimension: 'Cinematography Principles', weight: 15, description: 'Are camera, lens, movement, and lighting rules stated?' },
      { dimension: 'Reference Frames', weight: 10, description: 'Are visual references curated and contextualised?' },
    ],
    analysisPromptModifier: 'This is a VISUAL PROJECT BIBLE — a deterministic visual assembly document, NOT a narrative or screenplay document. Evaluate visual system coherence, production design specificity, and communicability. Do NOT evaluate logline, premise, narrative themes, dialogue, or screenplay formatting.',
    rewritePromptModifier: 'Strengthen visual specificity, coherence across domains, and production usability. Do NOT add narrative content, dialogue, or screenplay formatting.',
    convergenceRules: { minCI: 80, minGP: 75 },
    forbiddenCritique: ['logline', 'premise', 'narrative themes', 'dramatic structure', 'dialogue', 'screenplay formatting', 'scene construction'],
  },
};

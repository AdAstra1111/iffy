...
export interface SceneEvidence {
  ...
  /** Confidence 0–1 */
  confidence: number;
  /** Scene Index enrichment — scene_number from canonical scene_index */
  sceneNumber?: number;
  /** Scene Index enrichment — character_keys from scene_index */
  characterKeys?: string[];
  /** Scene Index enrichment — wardrobe_state_map from scene_index */
  wardrobeStateMap?: Record<string, string>;
  /** Scene Index enrichment — location_key from scene_index */
  locationKey?: string | null;
  /** Whether this evidence came from scene_index (high confidence binding) */
  fromSceneIndex?: boolean;
}

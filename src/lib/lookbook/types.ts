...
export interface SlideContent {
  ...
  /** Explicit resolution status for document-boundary enforcement */
  _resolutionStatus?: 'resolved' | 'unresolved' | 'partial';
  /** Working-set source provenance — which slots came from provisional images */
  _workingSetSources?: Record<string, string>;
  /** Hero Anchor Contract — audit metadata for hero-bearing slides */
  _heroAnchorId?: string | null;
  _heroAnchorInjected?: boolean;
}

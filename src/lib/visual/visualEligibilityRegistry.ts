/**
 * Visual Eligibility Registry — Frontend Mirror
 *
 * Mirrors supabase/functions/_shared/visualEligibilityRegistry.ts for
 * frontend-side eligibility checks. The API surface is identical so
 * consumers can swap imports without changing logic.
 */

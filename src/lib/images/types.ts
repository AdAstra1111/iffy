...
export type AssetGroup = 'character' | 'world' | 'key_moment' | 'visual_language' | 'poster' | 'hero_frame';
...
export const SHOT_PACKS: Record<AssetGroup, ShotType[]> = {
  ...
  poster: [], // legacy poster — use hero_frame instead
  hero_frame: ['wide', 'tableau'], // cinematic anchor stills
};
...
export const DOCUMENT_IMAGE_MAP: Record<string, ProjectImageRole[]> = {
  lookbook: ['poster_primary', 'hero_primary', 'lookbook_cover', 'character_primary', 'world_establishing', 'visual_reference'],
  ...
  hero_frames: ['hero_primary', 'hero_variant'],

...
export const clipEngineApi = {
  enqueueForRun: (projectId: string, blueprintId: string, force = false, enabledProviders?: string[], beatIndices?: number[]) =>
    callClipEngine('enqueue_for_run', { projectId, blueprintId, force, enabledProviders, beatIndices }),

...
interface DialogueAtomGridProps { atoms: DialogueAtom[]; isLoading: boolean; isRefreshing: boolean; isExtracting?: boolean; isGenerating?: boolean; lastUpdated: Date | null; error: string | null; onExtract: () => Promise<any>; onGenerate: () => Promise<any>; onResetFailed: () => Promise<any>; onRefresh: () => Promise<void>; }
...
export function DialogueAtomGrid({ atoms, isLoading, isRefreshing, isExtracting = false, isGenerating = false, lastUpdated, error, onExtract, onGenerate, onResetFailed, onRefresh }: DialogueAtomGridProps) {

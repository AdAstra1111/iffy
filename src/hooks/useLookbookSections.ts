...
export const SECTION_UPSTREAM_MAP: Record<CanonicalSectionKey, {
  ...
  world_locations: {
    ...
    icon: 'Globe',
    sources: ['Canon-bound locations', 'Approved world/location refs', 'Approved PD environment outputs', 'Location pack readiness'],
    populateCta: 'Pull from World References',
  },
  atmosphere_lighting: {
    label: 'Atmosphere & Lighting',
    icon: 'Sun',
    sources: ['Approved PD atmosphere outputs', 'Visual Style Authority profile', 'Temporal/time-of-day refs'],
    populateCta: 'Derive from Visual Pipeline',
  },
  texture_detail: {
    label: 'Texture & Detail',
    icon: 'Layers',
    sources: ['Approved PD surface/material outputs', 'Material/prop/surface references', 'Environmental texture frames'],
    populateCta: 'Pull from Detail References',
  },
  symbolic_motifs: {
    label: 'Symbolic Motifs',
    icon: 'Sparkles',
    sources: ['Approved PD production motifs', 'Approved symbolic imagery', 'Motif object/material systems'],
    populateCta: 'Pull from Production Motifs',
  },
  key_moments: {
    label: 'Key Moments',
    icon: 'Sparkles',
  ...
  hero_frames: {
    label: 'Hero Frames',
    icon: 'Image',
    sources: ['Hero frame anchor stills', 'Primary hero frame', 'Hero frame alternates'],
    populateCta: 'Generate Hero Frames',
  },
  poster_directions: {
    label: 'Poster Directions',
    icon: 'Image',
    sources: ['Governed hero frames', 'Approved world/environment refs', 'Key moment imagery', 'Atmosphere & motif references'],
    populateCta: 'Auto-assemble from upstream',
  },
};

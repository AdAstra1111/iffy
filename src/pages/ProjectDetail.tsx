        ...
        >
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {/* PRIMARY — Visual Production Pipeline */}
              <Link to={`/projects/${id}/visual-production`} className="sm:col-span-2">
                <div className="rounded-lg border border-primary/30 bg-primary/5 p-4 hover:bg-primary/10 transition-colors cursor-pointer">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-sm font-semibold text-foreground">Visual Production Pipeline</span>
                    <Badge variant="default" className="text-[9px] h-4 px-1.5">Primary</Badge>
                  </div>
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Cast → Production Design → Visual Language → Look Book — unified visual workflow.
                  </p>
                </div>
              </Link>

              {/* Visual Production Hub (legacy) */}
              <Link to={`/projects/${id}/visual-dev`}>
                <div className="rounded-lg border border-border/50 bg-card/30 p-3 hover:bg-card/60 transition-colors cursor-pointer h-full">
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    <span className="text-sm font-medium text-foreground">Visual Production Hub</span>
                  </div>
                  <p className="text-[11px] text-muted-foreground">Cast photos, references, visual canon, and archive.</p>
                </div>
              </Link>

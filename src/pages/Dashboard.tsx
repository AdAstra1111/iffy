...
import { Plus, Clapperboard, ArrowLeftRight, Kanban, Archive, FileDown, X, Building2, AlertTriangle, RefreshCw } from 'lucide-react';
...
export default function Dashboard() {
  const { projects, isLoading, error, refetch, togglePin, deleteProject } = useProjects();
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                {error
                  ...
                  : `${filteredProjects.length} project${filteredProjects.length !== 1 ? 's' : ''} classified${selectedCompanyId !== 'all' ? ` · ${displayCompany?.name || 'Company'}` : ''}`}
              </p>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-24 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-md">
                Your portfolio wasn’t confirmed, so the dashboard is being held out of the false-empty state. Retry the live fetch.
              </p>
